defmodule Arc.Storage.Azure do
  ...
  def delete(_definition, _version, {file, nil}) do
    ...
    ExAzure.request!(:delete_blob, [container(), server_object, [], timeout_in_milliseconds()])
    :ok
  end
  ...
  defp upload_file(destination_dir, file) do
    ...
    ExAzure.request(:put_block_blob, [
      container(),
      filename,
      get_binary_file(file),
      [],
  ...
  defp timeout_in_milliseconds do
    Application.get_env(:arc_azure, :timeout_in_milliseconds) || 30_000
  end
end
